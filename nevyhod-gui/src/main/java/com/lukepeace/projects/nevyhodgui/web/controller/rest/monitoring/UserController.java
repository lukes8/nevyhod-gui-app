...
public class UserController {
    ...
    public UserLoginVO login(@RequestBody UserLoginVO userLogin) {
        Authentication authenticationRequest = UsernamePasswordAuthenticationToken.unauthenticated(userLogin.getUsername(), userLogin.getPassword());
    ...
    @PostMapping(name = "update", consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @PreAuthorize(Permission.ACCESS_USER_DATA)
    ...
    @PreAuthorize(Permission.ACCESS_USER_DATA)
    public List<UserRoleVO> getAllUserRoles() throws GeneralException {
